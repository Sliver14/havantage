    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <section className="bg-gray-50 py-10 border-b border-gray-200 mb-10">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center text-gray-800 mb-2">Apply for Premium Training</h1>
          <p className="text-lg text-center text-gray-500">Take the first step towards advancing your career with our comprehensive training programs.</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-16">
            Why Choose Our Premium Training?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Expert Instructors</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Career Support</h3>
              <p className="text-gray-600">Get placement assistance and ongoing career guidance after training.</p>
            </div>
            <div className="text-center">
