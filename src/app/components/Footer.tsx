        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Premium technology partner committed to helping people and businesses succeed with cutting-edge solutions and expert guidance.
            </p>
            ...
            <div className="bg-blue-800 rounded-lg p-4">
              ...
              <div className="flex">
                <input 
                  ...
                  className="flex-1 px-3 py-2 bg-blue-700 border border-blue-600 rounded-l-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <button className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-r-lg transition-colors duration-300">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">hello@havantage.com</p>
                  <p className="text-gray-300">info@havantage.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-blue-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">+234 987 6543</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              &copy; 2025 Havantage Technologies. All rights reserved.
            </p>
            <div className="flex items-center space-x-4 mt-2 md:mt-0">
              <span className="text-gray-300 text-sm">Follow Us On:</span>
              <div className="flex space-x-2">
                <div className="w-6 h-6 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors duration-300 cursor-pointer">
